...
package me.ishift.commons.util;

import com.maxmind.db.CHMCache;
import com.maxmind.geoip2.DatabaseReader;
import com.maxmind.geoip2.exception.GeoIp2Exception;
import io.sentry.Sentry;
import me.ishift.commons.PhoenixCommons;
...
public class GeoAPI {
    ...
    public GeoAPI(String basePath, boolean country, boolean city) {
        try {
            PhoenixCommons.getPlugin().log("This product includes GeoLite2 data created by MaxMind, available from www.maxmind.com");
            PhoenixCommons.getPlugin().log("By using this software, you agree to GeoLite2 EULA (https://www.maxmind.com/en/geolite2/eula)");
    ...
    public String getCountryCode(String host) {
        ...
        if (address != null && getCountryReader() != null && !address.getHostAddress().equalsIgnoreCase("127.0.0.1")) {
            try {
                ...
                PhoenixCommons.getPlugin().log("Can't find country for address: " + host);
            }
        }
        return "Unknown?";
    }
    ...
    public String getCity(String host) {
        ...
        if (address != null && getCityReader() != null && !address.getHostAddress().equalsIgnoreCase("127.0.0.1")) {
            try {
                ...
                PhoenixCommons.getPlugin().log("Can't find city for address: " + host);
            }
        }
        return "Unknown?";
    }
    ...
    public InetAddress getAddress(String hostname) {
        try {
            ...
            PhoenixCommons.getPlugin().log("Can't resolve InetAddress from hostname: " + hostname);
        }
        return null;
    }
}
